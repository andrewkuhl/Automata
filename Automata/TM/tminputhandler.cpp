...
TMInputHandler::TMInputHandler(const char * argv[])
{
...
TMInputHandler::~TMInputHandler()
{
}
void TMInputHandler::getMS()
{
...
string TMInputHandler::getInput()
{
