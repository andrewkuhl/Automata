...
NFAInputHandler::NFAInputHandler(const char * argv[])
{
...
NFAInputHandler::~NFAInputHandler()
{
}
void NFAInputHandler::getMS()
{
...
string NFAInputHandler::getInput()
{
